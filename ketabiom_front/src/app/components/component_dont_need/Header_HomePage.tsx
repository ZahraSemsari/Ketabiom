      ...
      <header className="bg-white w-full shadow-[0px_1px_8px_0px_#236474] relative z-20">
        ...
        <div className="hidden sm:block">
          <div className="max-w-[1400px] mx-auto h-[70px] px-4 sm:px-6 lg:px-8 relative">
            ...
            <div className="absolute right-0 sm:right-1 lg:right-2 top-1/2 -translate-y-1/2 flex gap-1.5 sm:gap-1">
              {/* <button className="bg-buttons h-[40px] sm:h-[40px] px-4 sm:px-5 rounded-[20px] shadow-[0px_4px_4px_1px_rgba(0,0,0,0.25)] hover:bg-[#3a8599] transition-colors">
                <p className="font-['Arad:SemiBold',sans-serif] text-[15px] sm:text-[18px] text-white whitespace-nowrap">
                  ثبت نام
                </p>
              </button>
              <button className="bg-buttons h-[40px] sm:h-[40px] px-4 sm:px-5 rounded-[20px] shadow-[0px_4px_4px_1px_rgba(0,0,0,0.25)] hover:bg-[#3a8599] transition-colors">
 ...
 */}
              ...
              <Link
                to="/login"
                className="bg-buttons h-[40px] sm:h-[40px] px-4 sm:px-5 rounded-[20px] shadow-[0px_4px_4px_1px_rgba(0,0,0,0.25)] hover:bg-[#3a8599] transition-colors"
          ...
          <div className="px-3 py-3 space-y-2">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex gap-1.5">
                <button className="bg-buttons h-[30px] px-3 rounded-[15px] shadow-[0px_2px_4px_1px_rgba(0,0,0,0.25)] hover:bg-[#3a8599] transition-colors">
                  <p className="font-['Arad:SemiBold',sans-serif] text-[13px] text-white whitespace-nowrap">
                    ثبت نام
                  </p>
                </button>
                <button className="bg-buttons h-[30px] px-3 rounded-[15px] shadow-[0px_2px_4px_1px_rgba(0,0,0,0.25)] hover:bg-[#3a8599] transition-colors">
